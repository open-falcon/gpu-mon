...
func TestBuildMetaDatas(t *testing.T) {
	...
	wantMetaDataMap := map[string]MetaData{
		"GPUUtils":      {"GPUUtils", "testEndPoint", timestamp, 60, uintValue, "GAUGE", "GpuId=0"},
		"Rx":            {"Rx", "testEndPoint", timestamp, 60, uint64Value, "GAUGE", "GpuId=0"},
		"PowerUsed":     {"PowerUsed", "testEndPoint", timestamp, 60, float64Value, "GAUGE", "GpuId=0"},
		"DcgmSupported": {"DcgmSupported", "testEndPoint", timestamp, 60, intValue, "GAUGE", "GpuId=0"},
		"MemUtils":      {"MemUtils", "testEndPoint", timestamp, 60, -1, "GAUGE", "GpuId=0"},
	}
